...
namespace SavingAccounst.Data_Transfer_Object
{
    class DataProvider
    {
        private string connectionStr = @"Data Source=localhost\SQLEXPRESS;Initial Catalog=SavingAccount;Integrated Security=True";
        ...
        private static bool CheckDatabaseExists(SqlConnection tmpConn, string databaseName)
        {
            ...
            try
            {
                tmpConn = new SqlConnection(@"Data Source=localhost\SQLEXPRESS;Initial Catalog=master;Integrated Security=True");
        ...
        {
            if (!CheckDatabaseExists(new SqlConnection(), "SavingAccount"))
            {
                string script = File.ReadAllText(@".\Database.sql");
                
                using (SqlConnection connection = new SqlConnection(@"Data Source=localhost\SQLEXPRESS;Initial Catalog=master;Integrated Security=True"))
                {
